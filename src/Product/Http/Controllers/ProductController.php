...
class ProductController extends Controller
{
    ...
    public function destroy($ids)
    {
        ...
        if ($result > 0) {
            return response()->json(['message' => 'Produto(s) apagado(s) com sucesso'], 200);
        }

        return response()->json(['message' => 'Falha ao tentar apagar o(s) produto(s)', 'error' => true], 422);
    }
    ...
    {
        return response()->json($this->prodRepo->report($id), 200);
    }
}
